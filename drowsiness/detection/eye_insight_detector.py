...
from detection.detector import InsightDetector
...
class EyeInsightDetector(InsightDetector):
    ...
    def execute(self, images) -> DetectionData:
        ...
        if not ear_list:
            return DetectionData(0, {"blink_count": 0, "eye_opening": 0, "closed_eyes_time": 0})
